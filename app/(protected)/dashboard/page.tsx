                                ...
                                actions={[
                                    {
                                        ...
                                        onRun: () => router.push("/tasks?action=new" as never)
                                    },
                                    {
                                        id: "new-habit",
                                        label: "New Habit",
                                        ...
                                        onRun: () => router.push("/habits?action=new" as never)
                                    },
                                    {
                                        id: "new-log",
                                        label: "New Log",
                                        ...
                                        onRun: () => router.push("/daily-logs?action=new" as never)
                                    },
                                    {
                                        id: "new-note",
                                        label: "New Note",
                                        ...
                                        onRun: () => router.push("/notes?action=new" as never)
                                    }
                                ]}
                            />
                        }
