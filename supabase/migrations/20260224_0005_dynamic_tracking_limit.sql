-- Update get_tracking_analytics to support dynamic limit for top domains
-- and slightly improve performance

drop function if exists get_tracking_analytics(uuid, timestamptz);
...
begin
  ...
  -- 4. Get Top Domains with dynamic limit
